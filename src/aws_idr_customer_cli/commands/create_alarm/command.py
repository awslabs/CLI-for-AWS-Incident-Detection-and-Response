...
class CreateAlarm(CommandBase):
    ...
    \b
        idrcli create-alarm
        idrcli create-alarm --resume {sessionId}
        idrcli create-alarm -ma True
        idrcli create-alarm --verbose
        idrcli create-alarm --debug
    """
    ...
    def _execute_business_logic(
        ...
        if existing:
            ...
            if self.ui.prompt_confirm(
                ...
                self.ui.display_info(
                    "Please execute: idrcli register-workload. \n" "Exiting ..."
                )
                return {}
