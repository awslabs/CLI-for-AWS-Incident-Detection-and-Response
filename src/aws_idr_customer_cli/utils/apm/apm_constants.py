...
APM_WEBHOOK_RESUME_MESSAGE = (
    ...
    "   idrcli setup-apm --resume {session_id}"
)
...
EVENTBRIDGE_NAME_VALIDATION_ERROR = (
    ...
    "got: '{resource}'. "
    "Ensure the a Custom Event Bus was created using 'idrcli setup-apm'."
)
...
EVENTBRIDGE_MAX_RETRIES_ERROR = (
    ...
    "  1. Completed the APM setup using: idrcli setup-apm\n"
...
EVENTBRIDGE_NO_BUSES_ERROR = (
    ...
    "This could mean:\n"
    "  1. You haven't completed APM setup yet - run: idrcli setup-apm\n"
