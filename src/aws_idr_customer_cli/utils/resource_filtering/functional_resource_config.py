...
Original reference: https://tiny.amazon.com/fsrbzwbq/AmsCieWdiService/mainline/constants.py

Construct `service:resource-type` strings by referencing the
Service Authorization Reference https://tiny.amazon.com/atgyihwg/docsawsamazservlatereferefe
"""
